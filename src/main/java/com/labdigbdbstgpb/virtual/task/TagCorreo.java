...
public class TagCorreo implements Task {

    private final String tipoIdentificacion;
    private final String usuario;
    private final String clave;

    public TagCorreo(String tipoIdentificacion, String usuario, String clave) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(OPC_TAG),
                Enter.theValue("pruebasbb1@gmail.com").into(TXT_TAG),
