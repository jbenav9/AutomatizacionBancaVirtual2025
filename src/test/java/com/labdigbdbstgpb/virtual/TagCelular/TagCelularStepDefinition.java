package com.labdigbdbstgpb.virtual.TagCelular;

import com.labdigbdbstgpb.virtual.question.ValidarTagCelular;
import com.labdigbdbstgpb.virtual.question.ValidarTagCorreo;
import com.labdigbdbstgpb.virtual.task.TagCelular;
...
public class TagCelularStepDefinition {
    ...
    public void ingreseALaOpcionDeEnviarDineroPorTagAvalYElUsuarioIngresaElTagCelular(io.cucumber.datatable.DataTable dataTable) {
        ...
        BV.attemptsTo(TagCelular.con(tipoIdentificacion,usuario,clave));
    }
    ...
    public void leDaClickEnElBotonContinuarYVeraQueLaConsultaDelTagExitosa() {
        BV.should(seeThat("El usuario ve la DashBoar de BV", ValidarTagCelular.validarTagCelularExitoso(), Matchers.equalTo(false)));
