package com.labdigbdbstgpb.virtual.ValidacionTagExitosa;
...
public class ValidacionTagExistosaStepDefinition {
    ...
    @When("ingrese a la opcion de enviar dinero por tag aval y el usuario ingresa el tag {string}")
    public void ingreseALaOpcionDeEnviarDineroPorTagAvalYElUsuarioIngresaElTag(String tag) {
        BV.attemptsTo(ValidacionTagExitosa.conTag(tag));
    }
    ...
    public void leDaClickEnElBotonContinuarYVeraQueLaConsultaDelTagExitosa() {
        BV.should(seeThat(
                "El usuario ve la consulta del tag exitosa",
                ValidarTagNumerico.validarTagNumericoExitoso(), Matchers.equalTo(false)
