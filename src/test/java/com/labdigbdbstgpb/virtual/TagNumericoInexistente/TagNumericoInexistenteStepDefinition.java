package com.labdigbdbstgpb.virtual.TagNumericoInexistente;
...
public class TagNumericoInexistenteStepDefinition {
    ...
    public void ingreseALaOpcionDeEnviarDineroPorTagAvalYElUsuarioIngresaElTagAlfanumerico(io.cucumber.datatable.DataTable dataTable) {
        ...
        BV.attemptsTo(TagNumericoInexistente.con(tipoIdentificacion,usuario,clave));
    }
    ...
    public void leDaClickEnElBotonContinuarYVeraQueLaConsultaDelTagFallida() {
        BV.should(seeThat("El usuario ve la DashBoar de BV", ValidarTagNumericoInexistente.ValidarTagNumericoInexistente(), Matchers.equalTo(false)));
