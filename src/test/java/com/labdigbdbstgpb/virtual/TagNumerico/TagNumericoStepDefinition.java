package com.labdigbdbstgpb.virtual.TagNumerico;
...
public class TagNumericoStepDefinition {
    ...
    @When("ingrese a la opcion de enviar dinero por tag aval y el usuario ingresa el tag numerico")
    public void ingreseALaOpcionDeEnviarDineroPorTagAvalYElUsuarioIngresaElTagAlfanumerico(io.cucumber.datatable.DataTable dataTable) {
        ...
        BV.attemptsTo(TagNumerico.con(tipoIdentificacion,usuario,clave));
    }
    ...
    public void leDaClickEnElBotonContinuarYVeraQueLaConsultaDelTagExitosa() {
        BV.should(seeThat("El usuario ve la DashBoar de BV", ValidarTagNumerico.validarTagNumericoExitoso(), Matchers.equalTo(false)));
